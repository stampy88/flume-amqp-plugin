 ...
 * the value as different data types. Besides "simple" values, this class can interpret the
 * {@link #value} field as a comma-separated list of values. See {@link #stringValues()}.
 */
public class Option {
